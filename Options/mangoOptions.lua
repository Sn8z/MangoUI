...
local function RegisterSettings()
	...
	local powerOffsetLSlider = mUI:CreateSlider(-2000, 2000, 1, "Offset Left", mUI.profile.player.power.offsetL,
		playerPowerArea,
		function(value)
			mUI.profile.player.power.offsetL = value
		end)
	powerOffsetLSlider:SetPoint("TOP", powerHeightSlider, "BOTTOM", 0, -50)

	local powerOffsetRSlider = mUI:CreateSlider(-2000, 2000, 1, "Offset Right", mUI.profile.player.power.offsetR,
		playerPowerArea,
		function(value)
			mUI.profile.player.power.offsetR = value
		end)
	powerOffsetRSlider:SetPoint("TOP", powerWidthSlider, "BOTTOM", 0, -50)

	local powerOffsetYSlider = mUI:CreateSlider(-2000, 2000, 1, "Offset Y", mUI.profile.player.power.offsetY,
		playerPowerArea,
		function(value)
			mUI.profile.player.power.offsetY = value
		end)
	...
	local petPowerHeightSlider = mUI:CreateSlider(2, 200, 1, "Power Height", mUI.profile.pet.power.height, playerPetArea,
		function(value)
			mUI.profile.pet.power.height = value
		end)
	petPowerHeightSlider:SetPoint("LEFT", playerPetPowerCheck, "RIGHT", 120, 0)
	...
	local totPowerHeightSlider = mUI:CreateSlider(2, 200, 1, "Power Height", mUI.profile.targettarget.power.height, totArea,
		function(value)
			mUI.profile.targettarget.power.height = value
		end)
	totPowerHeightSlider:SetPoint("LEFT", totPowerCheck, "RIGHT", 120, 0)
