...
function mUI:CreateHealthPrediction(self)
	...
	healAbsorbBar:SetStatusBarTexture(LSM:Fetch("statusbar", mUI.config.defaultTexture))
	...
	myBar:SetStatusBarTexture(LSM:Fetch("statusbar", mUI.config.defaultTexture))
	...
	otherBar:SetStatusBarTexture(LSM:Fetch("statusbar", mUI.config.defaultTexture))
	...
	absorbBar:SetStatusBarTexture(LSM:Fetch("statusbar", mUI.config.defaultTexture))
